...
// Register
$register_text = get_theme_mod(
    'real_home_header_account_register_text',
    esc_html__( 'Register', 'real-home' )
);
$register_url = get_theme_mod(
    'real_home_header_account_register_url',
    '#'
);
...
<div class="header-account-wrap d-flex">
	...
	<a href="<?php echo esc_url( $register_url ); ?>" class="d-flex align-items-center" target="<?php echo esc_attr( $link_target ); ?>">
        <?php if ( $register_text !== '' ) : ?>
            <label><?php echo esc_html( $register_text ); ?></label>
        <?php endif; ?>
    </a>
	<?php }
	?>
