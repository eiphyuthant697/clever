...
<div class="header-button-wrap d-flex justify-content-center justify-content-md-end justify-content-lg-end">
    <a href="<?php echo esc_url( $button_url ); ?>" class="d-flex align-items-center header-btn" target="<?php echo esc_attr( $link_target ); ?>">
